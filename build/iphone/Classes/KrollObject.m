...
//@interface MissingOrWantedObject : NSObject
//@end

@interface MissingOrWantedObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MissingOrWantedObject class]])
		{
			for (NSString *key in [[(MissingOrWantedObject*)o modules] allKeys])
			{
